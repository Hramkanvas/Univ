...
public class Companies implements Decision {
    ...
    private void getCompanyByShortTitle(String shortTitle, String path) throws IOException, FileNotFoundException {
    ...
    private void getCompaniesByIndustry(String branch, String path) throws IOException, FileNotFoundException {
    ...
    private void getCompaniesByActivity(String activity, String path) throws IOException, FileNotFoundException {
    ...
    private void getCompaniesByDateOfFoundation(String downDate, String upDate, String path) throws IOException, FileNotFoundException, ParseException {
    ...
    private void getCompaniesByQuantityOfEmployees(int downQ, int upQ, String path) throws IOException, FileNotFoundException {
    ...
    public void makeDecision(int variant) throws Exception {
        Input in = new Input();
        switch (variant) {
            case 1:
            ...
            case 5:
                ...
                break;
                default:
                    throw new Exception("Illegal decision");
        }
    }
